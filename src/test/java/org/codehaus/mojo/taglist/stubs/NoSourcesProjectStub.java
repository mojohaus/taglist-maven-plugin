 ...
 */
public class NoSourcesProjectStub extends org.apache.maven.plugin.testing.stubs.MavenProjectStub {
    public List<String> getCompileSourceRoots() {
        return Collections.singletonList(
                PlexusTestCase.getBasedir() + "/target/test-classes/unit/no-sources-test/java-sources");
    }

    public List<String> getTestCompileSourceRoots() {
        return Collections.singletonList(
                PlexusTestCase.getBasedir() + "/target/test-classes/unit/no-sources-test/test-sources");
    }
}
